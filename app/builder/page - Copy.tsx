          ...
          {viewMode === "code" ? (
            ...
            <div className="flex-1 flex flex-col bg-white min-h-0">
              ...
              <div className="flex-1 relative overflow-hidden bg-white">
                {!rawPreviewHtml && !isBuilding && !loadedFiles && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#020617]">
                    ...
                    <h3 className="text-white font-bold text-xl mt-4">Scorpio Engine</h3>
                    <p className="text-slate-500 text-sm mt-2">Describe what you want to build or change</p>
                  </div>
                )}
